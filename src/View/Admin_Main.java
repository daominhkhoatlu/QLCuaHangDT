...
public class Admin_Main extends javax.swing.JFrame {
    ...
    public Admin_Main(String role) {
        ...
        for(int i=0;i<List_nv.size();i++){
            ...
            v_record.add(String.valueOf((int)List_nv.get(i).getLuong()));
    ...
    private void initComponents() {
        ...
        pannel_thongtin_nv.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
            ...
            .addGroup(pannel_thongtin_nvLayout.createSequentialGroup()
                ...
                .addGroup(pannel_thongtin_nvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pannel_thongtin_nvLayout.createSequentialGroup()
                        ...
                        .addGap(24, 24, 24))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pannel_thongtin_nvLayout.createSequentialGroup()
                        .addGap(2, 2, 2)
                        .addGroup(pannel_thongtin_nvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtLuong)
                            .addGroup(pannel_thongtin_nvLayout.createSequentialGroup()
                                .addComponent(rdbt_nam, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(119, 119, 119)
                                .addComponent(rdbt_nu, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)))
                        .addGap(23, 23, 23)))
                .addGroup(pannel_thongtin_nvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGap(48, 48, 48)
                .addGroup(pannel_thongtin_nvLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_ns, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
                    .addComponent(txt_dc)
                    .addComponent(cbb_cv, 0, 245, Short.MAX_VALUE)))
        );
        ...
        tb_nhanvien.setBackground(new java.awt.Color(240, 240, 240));
        ...
        panel_nhanvienLayout.setHorizontalGroup(
            ...
            .addGroup(panel_nhanvienLayout.createSequentialGroup()
                ...
                .addGroup(panel_nhanvienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pannel_chucnang_nv, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 719, Short.MAX_VALUE)
                    .addGroup(panel_nhanvienLayout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(jScrollPane1))
                    .addComponent(pannel_thongtin_nv, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
           ...
           int index=tb_nhanvien.getSelectedRow();
            ...
            try {
                NhanVien nv=new NhanVien(String.valueOf(tb_nhanvien.getValueAt(index, 0)),
                    ...
                    df.parse(txt_ns.getText()),txt_dc.getText(),txt_sdt.getText(),String.valueOf(cbb_cv.getSelectedItem()),Double.parseDouble(txtLuong.getText()));
                if(p.isSDT(txt_sdt.getText())){
                    ...
                    if(isValidDate(txt_ns.getText())&&df.parse(txt_ns.getText()).compareTo(d)<0){
                        if(nhanVienDataBase.UpdateNhanVien(nv)){
                            ...
                            dtm_nhanVien.setValueAt(txtLuong.getText(), index, 7);
                        }
                        else{
                    ...
                    if(p.isSDT(txt_sdt.getText())){
                        ...
                        if(isValidDate(txt_ns.getText())&&df.parse(txt_ns.getText()).compareTo(d)<0){
                            if(nhanVienDataBase.InsertNhanVien(nv)){      
                                ...
                                v_record.add(String.valueOf(nv.getLuong()));
                                v_content.add(v_record);
                                List_nv.add(nv);
                                dtm_nhanVien.setDataVector(v_content, v_header);
                        }
    ...
    private void tb_nhanvienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_nhanvienMouseClicked
        ...
        if(tb_nhanvien.getSelectedRow()>=0){
            ...
            txtLuong.setText(String.valueOf(List_nv.get(index).getLuong()));
        }
